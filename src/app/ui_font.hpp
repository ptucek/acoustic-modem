// Vygenerováno z third_party/imgui/misc/fonts/Roboto-Medium.ttf
// nástrojem imgui binary_to_compressed_c (-base85). Font Roboto (Apache-2.0),
// obsahuje Latin Extended-A → české glyfy (ř č ž ě ů ň š ď ť …). Vestavěný
// (base85) → identické vykreslení na macOS i Linuxu bez systémových fontů.
#pragma once
// File: 'third_party/imgui/misc/fonts/Roboto-Medium.ttf' (162588 bytes)
// Exported using binary_to_compressed_c.exe -base85 "third_party/imgui/misc/fonts/Roboto-Medium.ttf" UiFont
static const char UiFont_compressed_data_base85[144680+1] =
